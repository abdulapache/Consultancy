    ...
    <section>
        <div class="container-md shadow p-5 mb-3 mt-2">
            <div class="row">
                ...
                <div class="col-md-7">
                    <h6>WELCOME TO THE EMBASSY OF UAE, NEW DELHI</h6>
                    <p>Dear Visitors,<br>
                        <br>
                        On behalf of the Embassy of the United Arab Emirates in New Delhi, I have the pleasure to
                        welcome you to the Embassy’s website, which has been designed to provide the users an access to
                        the Embassy, and links with the Ministry of Foreign Affairs of UAE and other Government
                        Institutions.
                        <br>
                        <br>
                        The historical and close ties between India and UAE, marked by long standing relations between
                        the people of the two countries, are now being transformed into a strong strategic partnership.
                        The leaders of the two countries continuously enhance the bi-lateral relations. They underline
                        and emphasize the importance of strengthening co-operation in all the fields, especially
                        economic cooperations trade, industry investment and trade services.
                        <br>
                        <br>
                        Once again, I hope that our website is informative to our readers; therefore facilitating to
                        unveil the dynamic relations between India and the United Arab Emirates.
                        Sincerely yours,
                    </p>
                    <h6>DR. AHMED ALBANNA</h6>
                    <p>AMBASSADOR</p>
                </div>
