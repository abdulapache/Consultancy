            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="reference" class="form-control" id="exampleFormControlInput1" placeholder="Reference number" value="<?php echo $row['a_reference']?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Enter Passport Number:</label>
                        <input type="text" name="passport" class="form-control" id="exampleFormControlInput1" placeholder="Passport number" value="<?php echo $row['a_reference']?>>
                    </div>
