...
$query="SELECT * FROM user WHERE a_reference_number='".$reference."' AND a_passport_number='".$passport."'";
$q=mysqli_query($con, $query);
$row=mysqli_fetch_array($q);
if(!$row){
    echo "<script type='text/javascript'>alert('this is wrong Creditional');
	window.location.href='e-visa.php'</script>";
}
?>
            ...
            <div class="row">
                ...
                <div class="col-md-7">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="reference" class="form-control" id="exampleFormControlInput1" placeholder="Reference number" value="<?php echo $row['a_reference_number']?>">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Enter Passport Number:</label>
                        <input type="text" name="passport" class="form-control" id="exampleFormControlInput1" placeholder="Passport number" value="<?php echo $row['a_passport_number']?>" >
                    </div>
